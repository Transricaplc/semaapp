...
export const agencies: Agency[] = [
  ...
  {
    id: "ag-tarura",
    agency: "Tanzania Rural and Urban Roads Agency",
    acronym: "TARURA",
    sector: "Infrastructure",
    head: "Victor Seff",
    headTitle: "Chief Executive",
    contacts: {
      email: "info@tarura.go.tz",
      phone: "+255 22 2926100",
      hotline: "",
  ...
  {
    id: "ag-tanesco",
    agency: "Tanzania Electric Supply Company",
    acronym: "TANESCO",
    sector: "Infrastructure",
    head: "Lazaro Jacob Twange",
    headTitle: "Managing Director",
    contacts: {
      email: "md@tanesco.co.tz",
      phone: "+255 22 2451130",
      hotline: "0800 110 022",
      address: "Umeme Park, Dar es Salaam",
    },
    key_personnel: [],
    zonal_offices: [],
  },
  ...
  {
    id: "ag-tcra",
    agency: "Tanzania Communications Regulatory Authority",
    acronym: "TCRA",
    sector: "Regulatory",
    head: "Dkt. Jabiri Kuwe Bakari",
    headTitle: "Director General",
    contacts: {
      email: "dg@tcra.go.tz",
      phone: "+255 22 2199760",
      hotline: "0800 750 060",
  ...
  {
    id: "ag-tanroads",
    agency: "Tanzania National Roads Agency",
    acronym: "TANROADS",
    sector: "Infrastructure",
    head: "Eng. Patrick Mfugale",
    headTitle: "Chief Executive",
    contacts: {
      email: "info@tanroads.go.tz",
      phone: "+255 22 2926001",
      hotline: "",
  ...
  {
    id: "ag-ewura",
    agency: "Energy and Water Utilities Regulatory Authority",
    acronym: "EWURA",
    sector: "Regulatory",
    head: "Eng. Godfrey Chibulunje",
    headTitle: "Director General",
    contacts: {
      email: "info@ewura.go.tz",
      phone: "+255 22 2923513",
      hotline: "0800 110 033",
      address: "Harbour View Towers, Dar es Salaam",
    },
    key_personnel: [],
    zonal_offices: [],
  },
