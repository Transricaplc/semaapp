      ...
      >
        <div className="w-14 h-14 rounded-xl bg-yb-charcoal-mid flex items-center justify-center shrink-0">
          {official.profile_photo_url ? (
            ...
            <span className="text-xl font-bold text-primary">{official.full_name.charAt(0)}</span>
          )}
        </div>
        ...
        <div className="px-4 md:px-5 pb-4 pt-1 border-t border-border/50 animate-fade-in space-y-2">
          ...
          <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg bg-primary/10 text-foreground hover:bg-primary/15 transition-colors text-left">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground">Private & secure</p>
            </div>
          </button>
          ...
          >
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground">Attach to your report or petition</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground">Share profile securely</p>
            </div>
          </button>
